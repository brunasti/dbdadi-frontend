...
public class TableDefinitionView extends VerticalLayout {
    ...
    public TableDefinitionView(TableDefinitionClient client, DatabaseModelClient dbModelClient) {
        this.client = client;
    ...
    private void configureGrid() {
        ...
        grid.addColumn(TableDefinitionDto::getName).setHeader("Name").setSortable(true);
        grid.addColumn(TableDefinitionDto::getSchemaName).setHeader("Schema");
    ...
    private void openDialog(TableDefinitionDto item) {
        ...
        TextField schemaName = new TextField("Schema Name");
        ...
        if (item != null) {
            ...
            schemaName.setValue(item.getSchemaName() != null ? item.getSchemaName() : "");
        ...
        FormLayout form = new FormLayout(name, schemaName, dbModel, description);
        ...
        Button save = new Button("Save", e -> {
            try {
                TableDefinitionDto dto = TableDefinitionDto.builder()
                        .name(name.getValue())
                        .schemaName(schemaName.getValue())
